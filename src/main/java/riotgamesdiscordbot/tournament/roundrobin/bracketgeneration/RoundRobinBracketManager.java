...
public class RoundRobinBracketManager extends BracketManager  {
    ...
    public void sendRoundToChannel(int roundNum) {
        ...
        this.tournamentChannel.sendMessage("Round " + round.getRoundNum()).addFiles(FileUpload.fromData(round.generateImage())).complete();
    ...
    public void sendCurrentStandings() {
        File file = new File("src/main/resources/currentStandings/current_standing.png");
        FileUpload fileUpload = FileUpload.fromData(file);
        this.tournamentChannel.sendMessage("Current Standings").addFiles(fileUpload).complete();
