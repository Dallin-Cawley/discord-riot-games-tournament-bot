...
public abstract class Tournament implements Iterable<Team> {
    ...
    public Tournament(TournamentConfig tournamentConfig, MessageReceivedEvent event, Map<String, List<String>> teams, DiscordUser creator) {
        ...
        this.context = event.getChannel().asTextChannel();
        ...
        if (this.tournamentConfig.createChannels()) {
            ...
            CreateChannelInstructionMessageEvent channelCreateEvent = new CreateChannelInstructionMessageEvent(tournamentConfig.getMetadata());
            this.eventManager = new EventManager(discordLogger, this);
